...
for index, row in df_topCTR.iterrows():
    ...
    cur.execute("INSERT INTO top_20 (adv_id, product_id, click, impression, clickthroughrate, fecha_recom) VALUES (%(advertiser_id)s, %(product_id)s, %(click)s, %(impression)s, %(click-through-rate)s, %(fecha_recom)s);", row.to_dict())
