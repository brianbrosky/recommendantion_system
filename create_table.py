...
cur.execute('alter table top_20_ctr rename to top_20_prod')
cur.execute('alter table top_20 rename to top_20_ctr')
cur.execute('alter table top_20_prod rename to top_20')
